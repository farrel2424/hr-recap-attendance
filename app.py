...
_LOGIC_HTML = (
    ...
    '&rarr; tidak ada penalti Late / 1/2 UL'
    '</div>'
...
""", unsafe_allow_html=True)
    ...
    if sel_rows and file_bytes is not None:
        ...
        if idx < len(df_show):
            ...
            # Simpan pilihan ke state — jangan langsung panggil dialog di sini
    ...
    if st.session_state.dialog_target == "logic":
        st.session_state.dialog_target = None   # reset sebelum render
        show_logic_dialog()
